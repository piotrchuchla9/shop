...
import { IconTruck, IconHandGrab, IconPhone, IconHammer, IconArrowLeft, IconArrowRight } from '@tabler/icons-react';
...
const SliderComponent: React.FC = () => {
  ...
  return (
    <div className="relative w-[768px] max-w-full overflow-hidden">
      ...
      <button onClick={prevSlide} className="absolute left-0 top-1/2 transform -translate-y-1/2 text-white p-2"><IconArrowLeft /></button>
      <button onClick={nextSlide} className="absolute right-0 top-1/2 transform -translate-y-1/2 text-white p-2"><IconArrowRight /></button>
    </div>
  );
};
